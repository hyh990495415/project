...
class Index extends Controller
{
       ...
       if(input('?param.ctid')){
        ...
        //获取地区商品
            ...
            //获取省份商品
                ...
                $cityId=Db::name('city')->where(['prvid'=>$prvid])->field('ctid')->select();
    ...
    public function changeBase64(){
        $base64_img1 = $_POST['image1'];
        $base64_img2 = $_POST['image2'];
        $base64_img[]=$base64_img1;
        $base64_img[]=$base64_img2;
        $code=0;
        $img=[];
        $flag=false;
        ...
        if($code==5001){
            ...
            //百度人脸对比接口
            //{"result":[{"index_i":"0","index_j":"1","score":88.860290527344}],"result_num":1,"log_id":2356660696123116}'
